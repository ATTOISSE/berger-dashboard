...
export function OrderDetails() {
    ...
    const goToOrders = () => {
        navigate('/client/register', { state: { orders } });
    };
    ...
    const removeProduct = (id) => {
        Swal.fire({
            ...
            confirmButtonText: "Oui, retire le"
        }).then((result) => {
    ...
    const handleAnnule = (e) => {
        e.preventDefault()
        Swal.fire({
            title: "Voulez-vous annuler ce produit ?",
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
    ...
    return <>
        ...
        <div className="container mt-4">
            <h1 className="text-center">Bienvenue dans votre panier</h1>
                ...
                <tbody>
                    ...
                    {commandes.length > 0 && (
                        <tr>
                            ...
                            <td><a href="" className="btn btn-primary" onClick={goToOrders}>Commander</a></td>
                        </tr>
                    )}
                </tbody>
            </table>
